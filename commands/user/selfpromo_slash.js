...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (interaction.options.getUser('user')) {
      ...
      msg = `Please only self-promote in <#${config.getSelfPromoID()}>!\n\n`;
    }
    ...
    msg += `In the meantime, check out <#${config.getRoleMenuID()}> and assign yourself the Artist/Producer tag to unlock some extra channels. Also, please take a minute to check out our <#${config.getRulesID()}>\n\n`;
